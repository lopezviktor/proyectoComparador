...
if (!isset($_POST["nombre"]) || !isset($_POST["poblacion"]) ||
    ...
    $carpetaDestino = "C:/xampp/htdocs/comparadorPaises/imagenes/banderas/"; // Cambia esto por la ruta donde quieres guardar las imágenes
        ...
        if ((strpos($tipo,'jpeg') || strpos($tipo,'gif') || strpos($tipo,'png') || strpos($tipo,'bmp')) 
            ...
            //if($queryRegistro = 0) {               
                ...
                $insertar = mysqli_query($conexion, "INSERT INTO paises (nombre, bandera, poblacion, superficie, 
                    ...
                    VALUES ('$nombre', 'https://localhost/comparadorPaises/imagenes/banderas/$banderaNombre$tipo', 
