...
async function obtenerPaisesPorContinente(continente) {
    const listaFavoritos = document.getElementById('listaPaisesFavoritos');
    listaFavoritos.innerHTML = ''; // Limpiar la lista anterior
    try {
        const url = `../../backend/controlador/GenerarJsonPaisesFavoritos.php?continente=${encodeURIComponent(continente)}`;
...
function mostrarPaises(paises) {
    ...
    paises.forEach(pais => {
        ...
        listaFavoritos.appendChild(contenedor);
    });
}
